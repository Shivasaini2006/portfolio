...
export default function Hero() {
  return (
    <section className="py-16 fade-in-up relative overflow-hidden h-screen flex items-center">
      ...
      {/* Hero Content */}
      <div className="container mx-auto px-6 flex items-center justify-center relative z-10 w-full">
        <div className="text-center space-y-6 max-w-4xl">
          ...
          <p className="text-xl md:text-2xl text-cyan-100/90 font-light mx-auto leading-relaxed">
